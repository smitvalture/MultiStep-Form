...
const Add_Ons = ({ toggle, addonPlans, onclickArc, onclickAdv, onclickPro, selectedAddOns, handleAddOnSelection }) => {
  ...
  return (
    <div className="w-full h-full flex gap-4 flex-col justify-center items-center">
      ...
      >
        <div
          className={`md:w-5 w-4 h-4 md:h-5 p-1 flex justify-center items-center rounded border-gray-400 ${selectedAddOns.includes('online') ? 'bg-[#4840f5] border-transparent' : 'border-[1.5px]'}`}
        >
      ...
      >
        <div
          className={`md:w-5 w-4 h-4 md:h-5 p-1 flex justify-center items-center rounded border-gray-400 ${selectedAddOns.includes('large') ? 'bg-[#4840f5] border-transparent' : 'border-[1.5px]'}`}
        >
      ...
      >
        <div
          className={`md:w-5 w-4 h-4 md:h-5 p-1 flex justify-center items-center rounded border-gray-400 ${selectedAddOns.includes('custome') ? 'bg-[#4840f5] border-transparent' : 'border-[1.5px]'}`}
        >
