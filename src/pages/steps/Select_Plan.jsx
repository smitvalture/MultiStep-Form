...
const Select_Plan = ({ onclickAdv, onclickArc, onclickPro, activePlan, onclickToggle, toggle, costArc, costAdv, costPro }) => {
  ...
  return (
    <div className='w-full h-full flex flex-col gap-5 md:gap-0 md:grid md:gap-x-5 grid-cols-3 place-items-center'>

      <div onClick={onclickArc} className={`cursor-pointer w-full h-4/6 flex gap-4 md:flex-col items-start md:justify-between duration-300 border-[1.8px] rounded-md border-gray-300 ${activePlan === "arc" ? "border-purple-900" : "hover:border-[#9894ec]"} p-4 md:p-5`}>
      ...
      <div onClick={onclickAdv} className={`cursor-pointer w-full h-4/6 flex gap-4 md:flex-col items-start md:justify-between duration-300 border-[1.8px] rounded-md border-gray-300 ${activePlan === "adv" ? "border-purple-900" : "hover:border-[#9894ec]"} p-4 md:p-5`}>
      ...
      <div onClick={onclickPro} className={`cursor-pointer w-full h-4/6 flex gap-4 md:flex-col items-start md:justify-between duration-300 border-[1.8px] rounded-md border-gray-300 ${activePlan === "pro" ? "border-purple-900" : "hover:border-[#9894ec]"} p-4 md:p-5`}>
      ...
      <div className='col-span-3 mt-3 md:mt-0 w-full h-full flex justify-center items-start'>
